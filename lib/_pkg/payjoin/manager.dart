...
class PayjoinManager {
  ...
  Future<void> syncAndBroadcastAll() async {
    await _sessionStorage.syncAllSessions();
    // Additional logic to handle broadcasting if needed
  }
  ...
  static Future<void> _isolateSender(List<dynamic> args) async {
    ...
    final walletTx = args[4] as WalletTx;
